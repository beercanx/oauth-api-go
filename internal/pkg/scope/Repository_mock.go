...
func (_mock *MockRepository) FindById(id string) (Scope, error) {
	ret := _mock.Called(id)
	...
	var r0 Scope
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(string) (Scope, error)); ok {
		return returnFunc(id)
	}
	if returnFunc, ok := ret.Get(0).(func(string) Scope); ok {
		r0 = returnFunc(id)
	} else {
		r0 = ret.Get(0).(Scope)
	}
...
func (_c *MockRepository_FindById_Call) Return(scope Scope, err error) *MockRepository_FindById_Call {
	_c.Call.Return(scope, err)
	return _c
}

func (_c *MockRepository_FindById_Call) RunAndReturn(run func(id string) (Scope, error)) *MockRepository_FindById_Call {
	_c.Call.Return(run)
	return _c
}
